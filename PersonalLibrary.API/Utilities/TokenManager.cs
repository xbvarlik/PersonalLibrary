...
namespace PersonalLibrary.API.Utilities;
...
public class TokenManager
{
    ...
    public TokenManager(UserManager<User> userManager, RoleManager<Role> roleManager, IOptions<JwtBearerTokenSettings> jwtBearerTokenSettings, AppDbContext appDbContext)
    {
